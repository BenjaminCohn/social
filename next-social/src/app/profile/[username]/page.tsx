...
const ProfilePage = async ({params}:{params:{username:string}}) =>{
  ...
  if (isBlocked) return notFound();
    ...
    return ( 
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col items-center justify-center bg-blue-300">
          <div className="w-full h-64 relative">
            ...
            <Image src={user.avatar || "/noAvatar.png"} width={128} height={128} alt="" className="object-cover w-32 h-32 rounded-full absolute left-0 right-0 m-auto -bottom-16 ring-4 ring-white  "/>
          </div>
      ...
      <div className="hidden lg:block w-[30%]"><RightMenu user={user}/>
      </div>
    </div>
    )
}
