...
const AddPost = () =>{
    ...
    return ( 
        <div className="p-4 bg-white shadow-md rounded-lg flex gap-4 justify-between text-sm">
            {/*AVATAR*/}
            <Image src={user?. imageUrl ||"/noAvatar.png"} alt="Avatar" width={48} height={48} className="w-12 h-12 object-cover rounded-full "/>
             {/*POST*/}
          ...
          <div className="">
            ...
            <AddPostButton />
                ...
                {/*POST OPTIONS*/}
                <div className="flex items-start gap-4 mt-4 ttetxte-gray-400 flex-wrap">
                <CldUploadWidget uploadPreset="social" onSuccess={(result, {widget}) => {setImg(result.info) 
                    widget.close()
                    }}>
                        {({ open }) => {
                        return ( 
