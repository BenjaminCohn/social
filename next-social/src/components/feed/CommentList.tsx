...
const CommentList = ({comments, postId}: {comments:CommentWithUser[] ,postId:number}) =>{
    ...
    return ( 
        ...
        {user &&(
            ...
            <Image src={user.imageUrl || "/noAvatar.png"} alt="write" width={32} height={32} className="w-8 h-8 rounded-full"/>
         ...
         <div className="">
            ...
            {/*AVATAR*/}
            <Image src={comment.user.avatar || "/noAvatar.png"} alt="avatar" width={40} height={40} className="w-10 h-10 rounded-full"/>
            {/*DESC*/}
